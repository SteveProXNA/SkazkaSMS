...
S:Lforest_screen.screen_forest_screen_update$screen_type$1$126({2}DG,SC:U),B,1,4
S:Lforest_screen.screen_forest_screen_update$po$1$127({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lforest_screen.screen_forest_screen_update$ho$1$127({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Lforest_screen.screen_forest_screen_update$go$1$127({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lforest_screen.screen_forest_screen_update$random$1$127({1}SC:U),R,0,0,[b]
S:Lforest_screen.screen_forest_screen_update$input$1$127({1}SC:U),R,0,0,[l]
S:Lforest_screen.screen_forest_screen_update$value$1$127({1}SC:U),R,0,0,[l]
S:Lforest_screen.screen_forest_screen_update$xp$1$127({1}SC:U),B,1,-3
S:Lforest_screen.screen_forest_screen_update$add_armor$1$127({1}:S),R,0,0,[l]
S:Lforest_screen.screen_forest_screen_update$sloc0$1$0({2}DG,SC:U),B,1,-2
F:Fforest_screen$setup$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lforest_screen.setup$row$1$148({1}SC:U),R,0,0,[c]
S:Lforest_screen.setup$idx$1$148({1}SC:U),R,0,0,[b]
F:Fforest_screen$calc_add_armor$0$0({2}DF,:S),Z,0,0,0,0,0
S:Lforest_screen.calc_add_armor$go$1$153({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lforest_screen.calc_add_armor$eo$1$153({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
S:Lforest_screen.calc_add_armor$po$1$153({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lforest_screen.calc_add_armor$add_armor$1$153({1}:S),R,0,0,[c]
