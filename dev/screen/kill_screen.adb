...
S:Lkill_screen.screen_kill_screen_update$screen_type$1_0$95({2}DG,SC:U),B,1,4
S:Lkill_screen.screen_kill_screen_update$timer$1_0$96({1}SC:U),R,0,0,[a]
T:Fkill_screen$tag_struct_timer_object[({0}S:S$timer_count$0_0$0({2}SI:U),Z,0,0)({2}S:S$timer_value$0_0$0({2}SI:U),Z,0,0)]
S:G$global_timer_object$0_0$0({4}STtag_struct_timer_object:S),E,0,0
S:Fkill_screen$palette$0_0$0({2}SI:U),E,0,0
S:Fkill_screen$count$0_0$0({1}SC:U),E,0,0
S:Fkill_screen$flag$0_0$0({1}:S),E,0,0
