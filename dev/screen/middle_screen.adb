M:middle_screen
F:G$screen_middle_screen_load$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$screen_middle_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lmiddle_screen.screen_middle_screen_update$screen_type$1$10({2}DG,SC:U),B,1,4
F:Fmiddle_screen$section05$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:Fmiddle_screen$section04$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:Fmiddle_screen$section03$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lmiddle_screen.section03$index$1$14({1}SC:U),R,0,0,[b]
S:Lmiddle_screen.section03$row$1$14({1}SC:U),R,0,0,[c]
F:Fmiddle_screen$section02$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:Fmiddle_screen$section01$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lmiddle_screen.section01$row$1$18({1}SC:U),R,0,0,[b]
